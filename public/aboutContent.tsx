...
export const SoftSkillsCommunication = [
  {
    skill: "Communication",
    setting: "In a web development setting:",
    description: [
      "Leading online meetings",
      "Collaborating with my team and other departments",
      "Effectively communicating accessibility  requirements to ensure that website content is appropriate to all users from different backgrounds",
    ],
  },
  {
    skill: "Communication",
    setting: "Current assistant manager role:",
    description: ["Regular communication with CEO, managers and customers",
  "Learnt to communicate with various shareholders and provide induction and mentoring to new employees"],
  },
];

export const SoftSkillsTime = [
  { skill: "Time and project management", description: ["Managing portfolio website development and delivering a freelance project while working full-time as assistant manager ",
"Working in accordance with agile methodology as part of the web development internship",
"Understanding project requirements and prioritizing the workload",
